        ...
        <div className="max-w-6xl mx-auto px-4 py-20">
          ...
          <div className="relative z-50 md:hidden mb-4">
            <div className="flex justify-center">
              <button
                ...
                className="px-6 py-3 md:px-8 md:py-4 bg-gradient-to-br from-blue-600 via-blue-500 to-blue-600 hover:from-blue-700 hover:via-blue-600 hover:to-blue-700 text-white rounded-2xl transition-all duration-400 font-black shadow-2xl shadow-blue-600/50 hover:shadow-3xl hover:shadow-blue-700/60 text-sm md:text-lg border-2 border-blue-400/30"
              >
                {language === "en" ? "FR" : "EN"}
              </button>
            </div>
          ...
          <div className="hidden md:block relative z-50 mb-8">
            <div className="flex justify-center">
              <button
                onClick={() => setLanguage(language === "en" ? "fr" : "en")}
                className="px-8 py-4 bg-gradient-to-br from-blue-600 via-blue-500 to-blue-600 hover:from-blue-700 hover:via-blue-600 hover:to-blue-700 text-white rounded-2xl transition-all duration-400 font-black shadow-2xl shadow-blue-600/50 hover:shadow-3xl hover:shadow-blue-700/60 text-lg border-2 border-blue-400/30"
              >
                {language === "en" ? "FR" : "EN"}
              </button>
            </div>
          ...
          >
            <Link
              href="/"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-gray-800 to-gray-700 hover:from-gray-700 hover:to-gray-600 text-white transition-all duration-300 font-bold px-6 py-3 md:px-8 md:py-4 rounded-xl shadow-xl shadow-gray-500/30 hover:shadow-2xl hover:shadow-gray-500/50 active:scale-95 text-sm md:text-base"
            >
