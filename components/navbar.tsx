    ...
    <>
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded-lg transition-all duration-300 hover:scale-105"
              >
                {language === "en" ? "FR" : "EN"}
              </button>
              <a
                href="#contact"
                className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-xs font-medium rounded-lg transition-all duration-300 hover:scale-105"
              >
                {t.nav.contact}
              </a>
            </div>
        ...
        <div className="flex items-center justify-around px-2 py-3">
          ...
          >
            <div className="w-5 h-5 bg-gray-800 rounded-full flex items-center justify-center">
              <span className="text-[10px] font-semibold text-white">{language === "en" ? "FR" : "EN"}</span>
            </div>
            <span className="text-[10px]">{language === "en" ? "FR" : "EN"}</span>
          </button>
        </div>
      </nav>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-xl border-b border-gray-800">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <span className="text-xs text-gray-400">{t.footer.jobTitle}</span>
        </div>
      </div>
    </>
  )
