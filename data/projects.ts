...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Body Institut",
    type: {
      en: "Premium Client Form + CRM",
      fr: "Formulaire Client Premium + CRM"
    },
    description: {
      en: "Apple-grade client form with intelligent simulator, automated lead pipeline, and built-in admin CRM for beauty institute.",
      fr: "Formulaire client de niveau Apple avec simulateur intelligent, pipeline de leads automatisé et CRM admin intégré pour institut de beauté."
    },
    problemSolved: {
      en: "Body Institut provides a complete client form solution with smart simulator, lead management, and admin dashboard for beauty institute operations.",
      fr: "Body Institut fournit une solution de formulaire client complète avec simulateur intelligent, gestion des leads et dashboard admin pour les opérations d'institut de beauté."
    },
    role: {
    ...
    keyFeatures: {
      en: [
        "Apple-grade form design",
        "Smart simulator",
        "6-step recommendation",
        "Lead pipeline automation",
        "Admin CRM dashboard",
        "Security & rate limiting"
      ],
      fr: [
        "Design formulaire niveau Apple",
        "Simulateur intelligent",
        "Recommandation 6 étapes",
    ...
    demonstrates: {
      en: "This project demonstrates my ability to build premium client forms with advanced features like simulators, automated pipelines, and admin dashboards using modern Next.js.",
      fr: "Ce projet démontre ma capacité à construire des formulaires clients premium avec fonctionnalités avancées comme simulateurs, pipelines automatisés et dashboards admin en utilisant Next.js moderne."
    },
